...
#' @export AntAngiCool
#' @param Input_Sequence Protein Sequence
#' @param Classifier 1 if you want classifying with maximum Accuracy, 2 if maximum Sensivity is desired and 3 if maximum Specefity is desired
#' @return 1 if has interaction and 0 otherwise
#' @examples
#' AntAngiCool("AAPFLECQGN",2)
AntAngiCool = function(Input_Sequence,Classifier=1)
{
  ...
  }else
  {
    ...
    return(predict(modelFit,Extracted_Features))
  }
}
